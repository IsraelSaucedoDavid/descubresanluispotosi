...
@section('content')
    <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="btn btn-info" href="{{ url('establecimientos') }}">Regresar <span
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('filesestablecimiento.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group col-lg-6 col-m-6 col-6 mt-6">
                        ...
                        <select id="id_establecimiento" name="id_establecimiento" class="form-control" required value="">
                            <option value="">Selecciona...</option>

                            @foreach ($esta as $itemEsta)
                                <option value="{{ $itemEsta->id }}"> {{ $itemEsta->nom_esta }}</option>
                            @endforeach
                        </select><br>
                    </div>
        ...
        {{-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="btn btn-info" href="{{ url('filesestablecimiento') }}">Guardar <span
                                class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
        <form action="{{ route('filesestablecimiento.store') }}" method="POST" class="dropzone" id="my-awesome-dropzone">
        </form> --}}
        <br><br><br><br><br><br>
    </div>
@stop
